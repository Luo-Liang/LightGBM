...
*/
class MultiNodeBenchmark : public GBDTBase
{
public:
    /*!
  * \brief Constructor
  ...
  */
    ...
    {
        auto other_gbdt = reinterpret_cast<const MultiNodeBenchmark *>(other);
  ...
  */
    ...
    void PredictRaw(const double *, double *,
                    const PredictionEarlyStopInstance *) const override {}

    void PredictRawByMap(const std::unordered_map<int, double> &, double *,
                         const PredictionEarlyStopInstance *) const override {}

    void Predict(const double *, double *,
                 const PredictionEarlyStopInstance *) const override {}

    void PredictByMap(const std::unordered_map<int, double> &, double *,
                      const PredictionEarlyStopInstance *) const override {}

    void PredictLeafIndex(const double *, double *) const override {}

    void PredictLeafIndexByMap(const std::unordered_map<int, double> &, double *) const override {}

    void PredictContrib(const double *, double *,
                        const PredictionEarlyStopInstance *) const override;
  ...
  */
    std::string DumpModel(int, int) const override { return ""; }
  ...
  */
    std::string ModelToIfElse(int) const override { return ""; };
  ...
  */
    bool SaveModelToIfElse(int, const char *) const override { return true; }
  ...
  * \return is_finish Is training finished or not
  */
    bool SaveModelToFile(int , int , const char *) const override
    {
        return true;
    }
  ...
  */
    std::string SaveModelToString(int , int ) const override
    {
        return "";
    }
  ...
  */
    bool LoadModelFromString(const char *, size_t ) override {
        return true;
    }
  ...
  */
    std::vector<double> FeatureImportance(int , int) const override
    {
